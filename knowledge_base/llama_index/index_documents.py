#!/usr/bin/env python3
"""
Document indexing script for Voice AI Agent using the actual implementation.
This script indexes documents from knowledge_docs into the Pinecone vector store.
"""
import os
import sys
import asyncio
...
from llama_index.index_manager import IndexManager
from openai_pinecone_config import get_openai_config, get_pinecone_config
