...
class IndexManager:
    ...
    async def init(self):
        ...
        try:
            ...
            index_exists = self.index_name in index_list.names() if hasattr(index_list, 'names') else self.index_name in [idx.name for idx in index_list]
            ...
            if not index_exists:
                ...
                try:
                    ...
                    # Fall back to standard index creation if ServerlessSpec fails
